...
| **Version** | `1.1.4` |
| **Extensions File** | carica `plg_content_cfpurge-1.1.4.zip` (da `dist/`) |
...
| **Download URL** | `https://raw.githubusercontent.com/WebG-it/joomla-extensions/main/dist/plg_content_cfpurge-1.1.4.zip` |
